...
def Object_detection_yolo(image):
    ...
    net = cv2.dnn.readNet("/home/asl/catkin_ws/src/indoor_mobile_robot_perception/scripts/yolov4-tiny.cfg", "/home/asl/catkin_ws/src/indoor_mobile_robot_perception/scripts/yolov4-tiny.weights")

    #save all the names in file o the list classes

    classes = []

    with open("/home/asl/catkin_ws/src/indoor_mobile_robot_perception/scripts/coco.names", "r") as f:
